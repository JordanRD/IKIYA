...
export default function Delivery() {
    ...
    useEffect(() => {
        if (id_user) {
            getHistory({ id_user, id_order_status: 4,search, page, perPage,orderBy }, data => setDeliveryProduct(data))
        }
    }, [id_user, refresh, page,orderBy,search ])
    ...
    return (
        <PaginationComp page={page} search={search} setSearch={setSearch} perPage={perPage} setPage={setPage} length={deliveryProduct.length} setOrderBy={setOrderBy} orderBy={orderBy} >
