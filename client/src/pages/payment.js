...
export default function Payment() {
    ...
    return (
        <div style={{ height: '70vh', display: 'grid', placeItems: 'center', margin: '40px 0', gridTemplateColumns: '1fr 1fr' }}>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center', height: '450px', padding: '20px', border: '2px solid #1a242a' }}>
            ...
            { image.name &&
                <div style={{ display: 'flex', flexDirection: 'column', border: '2px solid #1a242a', padding: '20px', height: '450px', justifyContent: 'space-evenly' }}>
